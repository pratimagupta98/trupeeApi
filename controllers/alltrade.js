...
exports.tradelist = async (req, res) => {
  await Alltrade.find().populate("fnoindex_scrpt_name").populate("fnoequty_scrpt_name").populate("cash_scrpt_name").populate("expiryDate")
    .sort({ sortorder: 1 })
    .then((data) => resp.successr(res, data))
    .catch((error) => resp.errorr(res, error));
};
...
exports.editFnoindex = async (req, res) => {  
  const{qty,active_value,sl_type,FT1_type,FT2_type,FT3_type}  = req.body
       ...
       if (sl_type == "true") {
        ...
        pl = req.body.qty *(SL -  req.body.active_value)
        console.log("PL",pl)
      ...
      console.log("AV2",av2)
       ...
       let  FT1 =parseInt (trl) + parseInt(20)
       console.log("FT1",FT1)
       pl = req.body.qty *(FT1 -  req.body.active_value)
       console.log("PL",pl)
      ...
      console.log("AV2",av2)
       ...
       console.log("FT2",FT2)
       pl = req.body.qty *(FT2 -  req.body.active_value)
       console.log("PL",pl)
      ...
      console.log("AV2",av2)
       ...
       console.log("FT3",FT3)
       pl = req.body.qty *(FT3 -  req.body.active_value)
       console.log("PL",pl)
